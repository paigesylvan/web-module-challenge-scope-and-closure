...
/*Task 1: counterMaker()
  ...
  counter1 has count declared within the function, where as counter2's count is declared outside of the function.
  
  2. Which of the two uses a closure? How can you tell?
  counter1 uses closure because the function is referncing external variables.

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
  counter1 would be preferred if there is no more variables being declared, whereas counter 2 would be preferred if they were adding more variables or functions to invoke later. 
*/
